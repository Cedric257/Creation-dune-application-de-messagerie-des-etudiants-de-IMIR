...
<html>
<head>
  <title>Dezipper et Zipper le fichier</title>
...
<form action="" method="POST">
  <fieldset>
    ...
    <input type="submit" name="dounzip" class="submit" value="Dezipper"/>
  </fieldset>

  <fieldset>
    <h1>Zipper l'Archive</h1>
    ...
    <input type="submit" name="dozip" class="submit" value="Zipper"/>
  </fieldset>
</form>
